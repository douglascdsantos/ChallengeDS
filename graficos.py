...
def plot_countplot(dados, x, titulo, label_x: str, figsize: tuple = (8, 5), hue=None, small: bool = False):
    ...
    ax = sns.countplot(x=x, hue=hue, data=dados, palette='YlOrBr')
...
def boxplot(x, y,dados):
    plt.figure(figsize=(10, 5))
    sns.boxplot(x = x,  y = y, orient= 'h',  data = dados, palette ='YlOrBr' )
    plt.title(f"Boxplot de {x} por {y}", fontsize=16)
